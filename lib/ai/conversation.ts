...
- If there is no real hook, just be human. A genuine low-pressure message is better than a fake one.
...
- Never fabricate urgency, deals, or promotions that are not real.
...
- They are hesitant: be human first. No pitch. Just acknowledge it.
...
const TRIGGER_CONTEXT: Record<TriggerType, string> = {
  ...
  trade_in_window: 'This customer has owned their vehicle long enough that trade-in values are strong. Lead with the trade angle.',
  mileage_milestone: 'This customer is hitting a significant mileage milestone. Frame around the right time to trade before value drops.',
  orphan_customer: 'The previous salesperson left the dealership. Warm handoff. Acknowledge the rep left, introduce yourself, keep it brief.',
  recall: 'There is an active recall on their vehicle. Service call not a sales call — but make it easy for them to come in.',
  ...
  performance_upgrade: 'A performance upgrade just dropped on their vehicle of interest.',
  safety_feature: 'A new safety feature is available. Relevant if they have a family.',
  competitive_conquest: 'They drive a competing brand. Lead with curiosity, not a hard sell.',
}
