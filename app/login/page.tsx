...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    window.location.href = 'https://app.reviveleads.net/dashboard'
  }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900">ReviveAI</h1>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={e => e.key === 'Enter' && handleLogin()}
                placeholder="••••••••"
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 pr-10"
              />
              <button
                type="button"
